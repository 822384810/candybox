 ...
 */
  ...
  * 增加status=1，处理逻辑删除
  */
public class JdbcRegisteredClientService implements RegisteredClientRepository {
	 ...
	 */
	public JdbcRegisteredClientService(JdbcOperations jdbcOperations) {
	...
	public RegisteredClient findById(String id) {
		...
		return findBy("id = ? and status=1 ", id);
	}

	@Override
	public RegisteredClient findByClientId(String clientId) {
		Assert.hasText(clientId, "clientId cannot be empty");
		return findBy("client_id = ? and status=1", clientId);
	}
